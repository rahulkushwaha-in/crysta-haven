      ...
      <div className="section-padding">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:w-1/2 relative">
            <div className="opacity-0 animate-on-scroll relative w-full max-w-lg mx-auto">
          ...
          <div className="lg:w-1/2">
            <div className="opacity-0 animate-on-scroll" style={{ '--animation-delay': '0.2s' } as React.CSSProperties}>
              <p className="text-sm font-medium text-crysta-blue mb-2">ABOUT US</p>
              <h2 className="section-title mb-6">The Trusted Legacy of Crysta Investment</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                {highlights.map((item, index) => (
                  <div key={index} className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-crysta-blue flex-shrink-0 mt-0.5" />
